...
const uploadToCloundinary_1 = require("../helper/uploadToCloundinary");
const uploadSingle = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield (0, uploadToCloundinary_1.uploadToCloudinary)(req["file"].buffer);
    ...
    try {
        for (const key in req['files']) {
            ...
            for (let item of req['files'][key]) {
                const tmp = yield (0, uploadToCloundinary_1.uploadToCloudinary)(item.buffer);
